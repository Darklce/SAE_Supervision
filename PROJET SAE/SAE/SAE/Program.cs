...
namespace SAE
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            Mode_Manu_Distribution MonMode_Manu_Distribution;

            MonMode_Auto = new Mode_Auto();
            MonMode_Manu = new Mode_Manu();
            MonMode_Manu_P2 = new Mode_Manu_P2();
            MonMode_Manu_Distribution = new Mode_Manu_Distribution();
            MonMENU = new MENU();
            ...
            MonMode_Manu_Distribution.m_MENU = MonMENU;
            MonMENU.m_Mode_Manu_Distribution = MonMode_Manu_Distribution;
