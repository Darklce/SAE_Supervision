...
namespace SAE
{
    public partial class Mode_Manu : Form
    {
        ...
        {
            m_MENU.plc3.Write("M0.1", 1); // Turn on the output
        }

        private void m_button_Sortir_Up(object sender, MouseEventArgs e)
        {
            m_MENU.plc3.Write("M0.1", 0); // Turn off the output
        }
        ...
        {
            m_MENU.plc3.Write("M0.2", 1); // Turn on the output
        }

        private void m_BoutonTri_MouseUp(object sender, MouseEventArgs e)
        {
            m_MENU.plc3.Write("M0.2", 0); // Turn off the output
        }
        ...
        {
            m_MENU.plc3.Write("M0.3", 1); // Turn on the output
        }
        private void m_BoutonUsin_MouseUp(object sender, MouseEventArgs e)
        {
            m_MENU.plc3.Write("M0.3", 0); // Turn off the output
        }
        ...
        {
            m_MENU.plc3.Write("M0.4", 1); // Turn on the output
        }
        private void m_BoutonPalp_MouseUp(object sender, MouseEventArgs e)
        {
            m_MENU.plc3.Write("M0.4", 0); // Turn off the output
        }
        ...
        {
            m_MENU.plc3.Write("M0.6", 1); // Turn on the output
        }
        private void m_BoutonSaisir_MouseUp(object sender, MouseEventArgs e)
        {
            m_MENU.plc3.Write("M0.6", 0); // Turn off the output
        }
        ...
        {
            m_MENU.plc3.Write("M0.5", 1); // Turn on the output  
        }
        private void m_BoutonLacher_MouseUp(object sender, MouseEventArgs e)
        {
            m_MENU.plc3.Write("M0.5", 0); // Turn off the output
        }
        ...
        {
            m_MENU.plc3.Write("M0.7", 1); // Turn on the output
        }
        private void m_BoutonSortirNoir_MouseUp(object sender, MouseEventArgs e)
        {
            m_MENU.plc3.Write("M0.7", 0); // Turn off the output
        }
        ...
        {
            m_MENU.plc3.Write("M1.0", 1); // Turn on the output
        }
        private void m_BoutonSortirRouge_MouseUp(object sender, MouseEventArgs e)
        {
            m_MENU.plc3.Write("M1.0", 0); // Turn off the output
        }
